...
Table \@ref(tab:facecounts), the comparison of Animetrics and Manually annotated faces, gives the lowest amount in this regard. Table 5, Google, found the largest amount of faces that matched those manually annotated.
...
ct<-CrossTable(table(ManFaces$glasses, ManFaces$visorhat), 
           ...
           dnn = c("Glasses","Visor/hat"))

pander(ct, caption = "Contingency table comparing the amount of captured faces of players that were wearing accessories.")
```
