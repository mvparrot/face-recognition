...
Figure \@ref(fig:timeFigure) displays the processing time required by the APIs for each image.
...
```{r timeFigure, fig.cap="System time taken by the four APIs to finish searching individual images, by number of faces discovered. Skybiometry is the fastest, and Microsoft is the slowest. When there are few faces found there is more variable time taken per image.\\label{fig:timeFigure}"}
# 
# t1 <- ggplot(times) +  
