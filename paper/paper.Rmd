---
title: "Performance Comparison of Common Face Detection APIs in Video Stills from Professional Tennis Matches"
authors: 
...
knitr::kable(SceneAttributes, format = "latex", longtable=FALSE, booktabs =TRUE, caption = "Characteristics of the scene occuring when the still shot was taken, one option for each category was selected for each image.")
```
...
knitr::kable(FaceAttributes, format = "latex", longtable=FALSE, booktabs = TRUE, caption = "Characteristics of the faces captured, one option for each category was selected for each face manually tagged.")
```
