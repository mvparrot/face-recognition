...
# violin plot
t2 <- ggplot(times, aes(x= as.factor(n), time.sys.self)) +
  geom_violin(scale = "width") + ylim(0,0.08) +
  #geom_jitter(height = 0.005, width = 0.1, alpha=0.5) +
  facet_wrap(~ type) +
  xlab("Amount of faces found") +
  ylab("Time taken per image (Seconds)")
