...
### Face detection rate modelled in characteristics

A logistic regression model was used to assess the characteristics of the face and scene affecting detection.

A step wise method was used to determine the best regression model.
...
knitr::kable(ModelEstimatesTable, format = "latex", align=c("l", 
                                          ...
                                          "r", "l",
                                          "r", "l"),
             booktabs = TRUE, longtable=FALSE, caption="Evaluation of factors affecting face recognition by API. (** 0.01 * 0.05 . 0.01 - NS) Coefficients from logitics regression models shown. Glasses, visorhat, headangle lighting, shotangle and situation all contribute significantly to face detection.")
```

For the most part, the APIs were all affected by the same factors.
The factors that negatively affected all APIs were glasses, visor or hat. Background only negatively affected Google. Situation had different effects on each API.
