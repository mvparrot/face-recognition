...
No Face &527 & 787 & & No Face &638 & 676 \\\cline{1-3}\cline{5-7}
\end{tabular}
\\[1.5ex]
\begin{tabular}{ccccccc}\\\cline{1-3}\cline{5-7} 
...
The characteristics of the images that the API found Potential Faces in were considered. For example, there would is an uneven amount of faces with certain image attributes. These relationships can be explored in mosaics for the images that were all considered manually. The scene information was recorded and the combinations were shown to find how many potential faces were found with the combination of scene attributes.
