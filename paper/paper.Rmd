...
The use of accessories like glasses and head wear, visors or hats, is common during the Australian Open as play is mostly outdoors during daytime.  Table \@ref(tab:accessories) shows player use of head wear and glasses, as tagged manually. 
...
\begin{table}[htp]
%\parbox{.5\linewidth}{
\caption{Conditional proportions of faces of players wearing glassesor headwear or not, captured by the different software, as a proportion of the manually tagged faces. API's unaffected by glasses will have similar proportions for both categories. Animetrics had the biggest proportion difference, and thus, most affected. Google is the least affected.}
\bigskip
