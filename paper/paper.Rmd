...
\begin{table}[ht]
%\parbox{.5\linewidth}{
\caption{Detection rates of the APIs for different accessories, as measured against the manual tagging. Rate is the proportion of detected with the accessory relative to without. Google has higher detection rates than the other APIs when a player is wearing head wear or glasses. }
\bigskip
