...
Images from the Australian Open 2016 were provided by Tennis Australia, with the following specs: 6406 images, 800 $\times$ 450px 

Images were derived from, 5 minute segments taken from 105 video files, with a still shot stored every three seconds. The video files used were the broadcasts of the tennis matches shown on the Seven Network during the Australian Open 2016. The sample included an equal amount of females and males singles tennis matches.
Images contained the faces of many people, such as players, staff on the court and fans in the crowd. The sample was not filtered at this initial stage.
