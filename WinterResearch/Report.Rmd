...
(4) Results: 
Table 1 = Describe the characteristics of the images - how many? what are the typical situations? how many have faces? etc. 
...
Table 3= Evaluate the performance: what is the overall accuracy of each algorithm (sample should be annotated faces + all boxed identified by algorithms) 
  How often is type I error made (a face detached incorrectly)?   How often type II error (a face is incorrectly NOT detected)?   How often are duplicates? Rarely, notable as a point of interest but given only occurs when using animetrics it is not worth basing decisions on this characteristic.
