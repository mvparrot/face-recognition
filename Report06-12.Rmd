---
title: "Detecting Faces in Tennis Match Videos"
author: Stephanie Kobakian, Mitchell O'Hara Wild, Stephanie
  Kovalcik, Dianne Cook
...
```{r Scene-Attributes-Table, anchor="table"}
kable(SceneAttributes, format = "pandoc", booktabs = TRUE, caption = figr("Scene-Attributes-Table", TRUE, type="Table"))
```

`r figr("Scene-Attributes-Table", TRUE, type="Table")`   Yayyy 
