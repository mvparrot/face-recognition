...
knitr::kable(ImageCharacteristics, booktabs = TRUE, longtable=TRUE, caption="", format = "markdown")
```
...
knitr::kable(GoogleNoMatch[1:10,], caption="", longtable=TRUE, format = "markdown")
...
knitr::kable(FaceCharacteristics, caption="", longtable=TRUE, format = "markdown")
```
...
knitr::kable(Accuracy, caption="", longtable=TRUE, format = "markdown")
...
knitr::kable(GoogleCharacteristics, format = "markdown", longtable=TRUE, booktabs = TRUE, caption="")
```
