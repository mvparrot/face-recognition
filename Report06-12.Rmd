...
```{r tableAMt, reaults='asis', fig.width=1}
knitr::kable(AM, booktabs = TRUE, longtable=F, format="latex")
```

```{r tableGMt, reaults='asis', fig.width=1}
knitr::kable(GM, booktabs = TRUE, longtable=F, format="latex")
```

```{r tableMMt, reaults='asis'}
knitr::kable(MM, booktabs = TRUE, longtable=F, format="latex")
```

```{r tableSMt, reaults='asis'}
knitr::kable(SM, booktabs = TRUE, longtable=F, format="latex")
```
