...
MosaicShotangle<- ggplot(data=ALLmetaIMGnamedFaces) + 
...
MosaicSit<- ggplot(data=ALLmetaIMGnamedFaces) + 
...
sbbgshot <- ggplot(data=ALLmetaIMGnamedFaces) +
...
sbbgsit <- ggplot(data=ALLmetaIMGnamedFaces) +
...
```{r ICFigs, out.width = 0.8, fig.cap = "\\label{fig:ICFigs}"}
